 ...
 */
package org.gecko.emf.persistence.jpa.model.orm.tests;
...
import org.gecko.emf.persistence.jpa.model.orm.provider.ORMappingProvider;
import org.gecko.emf.persistence.jpa.model.orm.provider.impl.ORMappingProviderImpl;
...
public class ORMappingProviderImplTest {
	...
	void test(@InjectService() ORMappingProvider orMappingProvider) {
		...
		assertThat(entity.getClass_()).isEqualTo("org.gecko.emf.persistence.jpa.model.orm.tests.model.base.Simple");
