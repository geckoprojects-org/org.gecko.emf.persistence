 ...
 * </p>
 * <ul>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.EntityListeners#getEntityListener <em>Entity Listener</em>}</li>
 * </ul>
 *
 * @see org.gecko.emf.persistence.jpa.model.orm.OrmPackage#getEntityListeners()
...
public interface EntityListeners extends EObject {
	 ...
	 * The list contents are of type {@link org.gecko.emf.persistence.jpa.model.orm.EntityListener}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Entity Listener</em>' containment reference list.
	 * @see org.gecko.emf.persistence.jpa.model.orm.OrmPackage#getEntityListeners_EntityListener()
