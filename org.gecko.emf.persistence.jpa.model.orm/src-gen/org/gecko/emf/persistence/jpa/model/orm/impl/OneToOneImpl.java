 ...
 * </p>
 * <ul>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getPrimaryKeyJoinColumn <em>Primary Key Join Column</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getPrimaryKeyForeignKey <em>Primary Key Foreign Key</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getJoinColumn <em>Join Column</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getForeignKey <em>Foreign Key</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getJoinTable <em>Join Table</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getCascade <em>Cascade</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#isId <em>Id</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getMappedBy <em>Mapped By</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getMapsId <em>Maps Id</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#isOptional <em>Optional</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#isOrphanRemoval <em>Orphan Removal</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.OneToOneImpl#getTargetEntity <em>Target Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
