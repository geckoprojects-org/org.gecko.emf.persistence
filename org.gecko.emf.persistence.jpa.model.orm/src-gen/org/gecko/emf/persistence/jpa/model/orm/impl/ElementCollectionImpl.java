 ...
 * </p>
 * <ul>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getOrderBy <em>Order By</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getOrderColumn <em>Order Column</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getMapKey <em>Map Key</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getMapKeyClass <em>Map Key Class</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getMapKeyTemporal <em>Map Key Temporal</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getMapKeyEnumerated <em>Map Key Enumerated</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getMapKeyAttributeOverride <em>Map Key Attribute Override</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getMapKeyConvert <em>Map Key Convert</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getMapKeyColumn <em>Map Key Column</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getMapKeyJoinColumn <em>Map Key Join Column</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getMapKeyForeignKey <em>Map Key Foreign Key</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getColumn <em>Column</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getTemporal <em>Temporal</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getEnumerated <em>Enumerated</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getLob <em>Lob</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getAttributeOverride <em>Attribute Override</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getAssociationOverride <em>Association Override</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getConvert <em>Convert</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getCollectionTable <em>Collection Table</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ElementCollectionImpl#getTargetClass <em>Target Class</em>}</li>
 * </ul>
 *
 * @generated
 */
