...
import org.gecko.emf.persistence.jpa.model.orm.Basic;
import org.gecko.emf.persistence.jpa.model.orm.CascadeType;
import org.gecko.emf.persistence.jpa.model.orm.CollectionTable;
import org.gecko.emf.persistence.jpa.model.orm.Column;
import org.gecko.emf.persistence.jpa.model.orm.ColumnResult;
import org.gecko.emf.persistence.jpa.model.orm.ConstraintMode;
import org.gecko.emf.persistence.jpa.model.orm.ConstructorResult;
import org.gecko.emf.persistence.jpa.model.orm.Convert;
import org.gecko.emf.persistence.jpa.model.orm.Converter;
import org.gecko.emf.persistence.jpa.model.orm.DiscriminatorColumn;
import org.gecko.emf.persistence.jpa.model.orm.DiscriminatorType;
import org.gecko.emf.persistence.jpa.model.orm.DocumentRoot;
import org.gecko.emf.persistence.jpa.model.orm.ElementCollection;
import org.gecko.emf.persistence.jpa.model.orm.Embeddable;
import org.gecko.emf.persistence.jpa.model.orm.EmbeddableAttributes;
import org.gecko.emf.persistence.jpa.model.orm.Embedded;
import org.gecko.emf.persistence.jpa.model.orm.EmbeddedId;
...
import org.gecko.emf.persistence.jpa.model.orm.EntityResult;
import org.gecko.emf.persistence.jpa.model.orm.EnumType;
import org.gecko.emf.persistence.jpa.model.orm.FetchType;
import org.gecko.emf.persistence.jpa.model.orm.FieldResult;
import org.gecko.emf.persistence.jpa.model.orm.ForeignKey;
import org.gecko.emf.persistence.jpa.model.orm.GeneratedValue;
import org.gecko.emf.persistence.jpa.model.orm.GenerationType;
import org.gecko.emf.persistence.jpa.model.orm.Id;
...
import org.gecko.emf.persistence.jpa.model.orm.InheritanceType;
import org.gecko.emf.persistence.jpa.model.orm.JoinColumn;
import org.gecko.emf.persistence.jpa.model.orm.JoinTable;
import org.gecko.emf.persistence.jpa.model.orm.Lob;
import org.gecko.emf.persistence.jpa.model.orm.LockModeType;
import org.gecko.emf.persistence.jpa.model.orm.ManyToMany;
import org.gecko.emf.persistence.jpa.model.orm.ManyToOne;
import org.gecko.emf.persistence.jpa.model.orm.MapKey;
import org.gecko.emf.persistence.jpa.model.orm.MapKeyClass;
import org.gecko.emf.persistence.jpa.model.orm.MapKeyColumn;
import org.gecko.emf.persistence.jpa.model.orm.MapKeyJoinColumn;
import org.gecko.emf.persistence.jpa.model.orm.MappedSuperclass;
import org.gecko.emf.persistence.jpa.model.orm.NamedAttributeNode;
...
import org.gecko.emf.persistence.jpa.model.orm.NamedSubgraph;
import org.gecko.emf.persistence.jpa.model.orm.OneToMany;
import org.gecko.emf.persistence.jpa.model.orm.OneToOne;
import org.gecko.emf.persistence.jpa.model.orm.OrderColumn;
import org.gecko.emf.persistence.jpa.model.orm.OrmFactory;
import org.gecko.emf.persistence.jpa.model.orm.OrmPackage;
import org.gecko.emf.persistence.jpa.model.orm.ParameterMode;
import org.gecko.emf.persistence.jpa.model.orm.PersistenceUnitDefaults;
import org.gecko.emf.persistence.jpa.model.orm.PersistenceUnitMetadata;
...
import org.gecko.emf.persistence.jpa.model.orm.QueryHint;
...
import org.gecko.emf.persistence.jpa.model.orm.StoredProcedureParameter;
import org.gecko.emf.persistence.jpa.model.orm.Table;
import org.gecko.emf.persistence.jpa.model.orm.TableGenerator;
import org.gecko.emf.persistence.jpa.model.orm.TemporalType;
import org.gecko.emf.persistence.jpa.model.orm.Transient;
import org.gecko.emf.persistence.jpa.model.orm.UniqueConstraint;
import org.gecko.emf.persistence.jpa.model.orm.Version;

import org.gecko.emf.persistence.jpa.model.orm.util.OrmValidator;
...
public class OrmPackageImpl extends EPackageImpl implements OrmPackage {
	 ...
	 * @see org.gecko.emf.persistence.jpa.model.orm.OrmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
