 ...
 * </p>
 * <ul>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#getJoinColumn <em>Join Column</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#getForeignKey <em>Foreign Key</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#getJoinTable <em>Join Table</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#getCascade <em>Cascade</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#isId <em>Id</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#getMapsId <em>Maps Id</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#isOptional <em>Optional</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.orm.impl.ManyToOneImpl#getTargetEntity <em>Target Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
