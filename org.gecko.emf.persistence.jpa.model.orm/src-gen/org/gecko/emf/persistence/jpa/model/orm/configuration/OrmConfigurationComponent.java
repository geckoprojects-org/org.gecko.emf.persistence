 ...
 */
package org.gecko.emf.persistence.jpa.model.orm.configuration;
...
import org.gecko.emf.persistence.jpa.model.orm.impl.OrmPackageImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.persistence.jpa.model.orm.OrmFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=org.eclipse.emf.ecore,org.gecko.emf.persistence.jpa.model.orm" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.persistence.jpa.model.orm.OrmPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=org.eclipse.emf.ecore,org.gecko.emf.persistence.jpa.model.orm" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.EPackageConfigurator\"" , "uses:=org.eclipse.emf.ecore,org.gecko.emf.persistence.jpa.model.orm" })
