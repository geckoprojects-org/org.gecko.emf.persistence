 ...
 * </p>
 * <ul>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.emfmapping.impl.JoinColumnImpl#getColumnDefinition <em>Column Definition</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.emfmapping.impl.JoinColumnImpl#isInsertable <em>Insertable</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.emfmapping.impl.JoinColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.emfmapping.impl.JoinColumnImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.emfmapping.impl.JoinColumnImpl#getReferencedColumnName <em>Referenced Column Name</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.emfmapping.impl.JoinColumnImpl#getTable <em>Table</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.emfmapping.impl.JoinColumnImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.model.emfmapping.impl.JoinColumnImpl#isUpdatable <em>Updatable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinColumnImpl extends MinimalEObjectImpl.Container implements JoinColumn {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.eINSTANCE.getJoinColumn();
	}
